...
pub use adavigator_primitives::{AccountId, Signature};
use adavigator_primitives::{Balance, BlockNumber, Hash, Index, Moment};
use codec::Encode;
use frame_support::{
	construct_runtime,
...
use pallet_evm::{
	Account as EVMAccount, EnsureAddressNever, EnsureAddressRoot, EnsureAddressSame, FeeCalculator,
	GasWeightMapping, IdentityAddressMapping, Runner,
};
...
/// wrap the rpc call to substrate transactions
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("adavigator"),
	impl_name: create_runtime_str!("adavigator"),
	authoring_version: 1,
...
impl pallet_session::Config for Runtime {
	...
	type SessionManager = pallet_session::historical::NoteHistoricalRoot<Self, Headquarters>;
...
impl pallet_session::historical::Config for Runtime {
	...
	type FullIdentificationOf = pallet_headquarters::ExposureOf<Runtime>;
}
...
impl pallet_evm::Config for Runtime {
	...
	// TODO impl H160 into AccountId20
...
impl pallet_headquarters::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
}
...
construct_runtime!(
	pub enum Runtime where
		Block = Block,
		NodeBlock = adavigator_primitives::Block,
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Headquarters: pallet_headquarters,
		Beefy: pallet_beefy,
		Mmr: pallet_mmr,
