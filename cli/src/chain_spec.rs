...
pub use adavigator_primitives::{AccountId, Balance, Signature};
use adavigator_runtime::{
	constants::currency::ADA, wasm_binary_unwrap, BabeConfig, BalancesConfig, Block, EVMConfig,
	EthereumConfig, GenesisAccount, GenesisConfig, GrandpaConfig, ImOnlineConfig, Precompiles,
...
pub fn authority_keys_from_account_and_seed(
	account: AccountId,
	seed: &str,
) -> (AccountId, BabeId, GrandpaId, ImOnlineId, BeefyId) {
	(
		account,
...
pub fn testnet_genesis(
	...
	let endowed_accounts: Vec<AccountId> = endowed_accounts.unwrap_or_else(|| {
		vec![
			...
			AccountId::from_str("38865461229E489aeBb8162a087C7011A579fD7e").unwrap(),
		]
	});

	const ENDOWMENT: Balance = 10_000_000 * ADA;
	...
	GenesisConfig {
		...
		babe: BabeConfig {
			authorities: vec![],
			epoch_config: Some(adavigator_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
